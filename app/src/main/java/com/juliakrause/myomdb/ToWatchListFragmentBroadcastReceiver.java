...
public class ToWatchListFragmentBroadcastReceiver extends BroadcastReceiver {
    public static final String ACTION_SHOW_TO_WATCH_LIST = "com.juliakrause.myomdb.ToWatchListFragmentBroadcastReceiver.ACTION.SHOW_TO_WATCH_LIST";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (intent != null) {
            ...
            if (ACTION_SHOW_TO_WATCH_LIST.equals(action)) {
                ...
                //toWatchListFragment.updateMovies(moviesToWatch);
            }
        }
    }
